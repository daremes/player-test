...
const getHashSalt = (hashSalt: string, date: Date) => {
  return `${hashSalt}${date.getFullYear()}${(date.getMonth() + 1)
    .toString()
...
export const getLegacyPlayerHash = (hashSalt: string, date = new Date()) => {
